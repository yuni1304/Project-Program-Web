    ...
    <div class="container py-5">
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                ...
                <p class="fs-5">Camilan enak, gak ribet, langsung sampai rumah.</p>
                <p class="fs-5">Di sini kamu bisa nemuin macam-macam camilan dari kue kering buat teman ngeteh, kue basah yang lembut banget, sampai kue ulang tahun dan hampers cantik buat ngasih kejutan ke orang tersayang.</p>
                <p class="fs-5">Kami pilih semua produk dari pembuat lokal yang jago bikin camilan enak dan tampilannya pun gak kalah keren. Jadi, selain nikmat di mulut, juga enak dilihat.</p>
                <p class="fs-5">Karena menurut kami, camilan itu lebih dari sekadar makanan.</p>
                <p class="fs-5"><strong>Camilan bisa jadi hadiah, penghilang stres, teman ngobrol, atau sekadar pengingat kalau hari ini gak seburuk itu.</strong></p>
            </div>
        </div>
    </div>
